...
thumbnail: "/posts/unified/plist-unified.png"
  ...
  - section_layout: 3col
    images:
      - caption:
        ...
        url: '/posts/unified/unified-globe-icon-guides.png'
        width:
        height:

      - caption:
        description: Watch icon
        url: '/posts/unified/unified-watch-icon-guides.png'
        width:
        height:

      - caption:
        description: Paint bucket icon
        url: '/posts/unified/unified-fill-icon-guides.png'
        width:
        height:
  ...
  - section_layout: 1col
    images:
      - caption: |
        ...
        url: '/posts/unified/unified-icon-specimen.png'
        width:
        height:
